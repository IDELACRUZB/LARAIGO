...
with open(jsonDataReports, "r") as json_file:
    ...
    for platform in data['laraigo']:        
        ...
        for campaign in data['laraigo'][str(platform)]:
...
for file in FILES_PATH:        
    result = mReport.loadData(file['path'], file['table'], file['db'], file['tipo'], file['fecha_insert'], file['properties']['dbType'], file['properties']['renameColumns'], file['properties']['converters'])
